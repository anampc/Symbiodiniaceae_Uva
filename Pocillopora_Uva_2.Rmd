...
# ggsave(file="FigAndrewsFavoriteGraph_Colony.svg", plot=Community_Changes3, width=6, height=6)
...
#ggsave(file="LogLog_labels.svg", plot=Community_Changes6, width=6, height=6)
