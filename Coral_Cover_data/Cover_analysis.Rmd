...
#### Non-Pocillipora scleractinians 
...
# All years 1970_2014 
  model1 <- lme(
    Coral_cover ~ -1 + Thermal_regime * Year, random = ~1|Region, data=cover)
